...
public class Lesson05Activity extends AppCompatActivity implements RobotLifecycleCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_start).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(say==null || (sayFuture!=null && !sayFuture.isDone())){
                    Log.d("Lesson05Activity", "cancel");
                }
